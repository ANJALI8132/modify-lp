...
if(isset($_POST['submit']) and !empty($_POST['submit'])){
    ...
    $mail1_subject="MODIFY Enquiry from Google Ads, " . $name;
    ...
    $apiKey = urlencode('gYF71b1ZHoXHLvz8');
    $utm_id = "1237072487";
    $agent = "76604489";
...
// More headers
$headers .= 'From: <modifytly@gmail.com>' . "\r\n";

$to = "viralmafiacs2@gmail.com, cyril.viralmafia@gmail.com, leads.viralmafia@gmail.com";
$url = 'http://viralmafia.com/demo/jsonmailermodify.php';
$ch = curl_init($url);
$data = array(
    'to' => $to,
